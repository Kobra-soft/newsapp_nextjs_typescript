...
function Header() {
  return (
    <header>
        <div className='grid grid-cols-3 p-4 sm:p-6 md:p-8 items-center'>
            <Bars3Icon className="h-8 w-8 cursor-pointer"/>
            <Link href="/" prefetch={false}>
                <h1 className={`${poppins.className} lg:text-[38px] text-2xl sm:text-2xl md:text-2xl text-center`}>News Hub</h1>
            </Link>
